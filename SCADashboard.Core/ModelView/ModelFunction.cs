...
namespace SCADashboard.Core.ModelView
{
    public class ModelFunction
    {
        ...
        public async Task SendSecurityEmailAsync(string email, string userName, string action, string actionUrl,string Templete)
        {
        ...
        public static string GetTemplate(TemplateType templateType)
        {
            ...
            {
                TemplateType.PasswordReset => "Template/PasswordReset.html",
                TemplateType.EmailVerification => "Template/EmailVerification.html",
